export function SkillsTable() {
    return (
      <section className="w-full sm:max-w-2xl md:max-w-3xl mx-auto pt-14 px-6">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 text-sm text-muted-foreground font-mono">
          <div>
